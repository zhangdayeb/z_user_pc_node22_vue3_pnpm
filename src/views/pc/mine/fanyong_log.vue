<template>
  <div class="pc-fanyong-record">
    ...
    <div class="pc-header">
      ...
      <h2 class="page-title">{{ t('records.commissionRecord') }}</h2>
    </div>
    ...
    <div class="pc-content">
      ...
      <el-table
        ...
        :data="list"
        class="record-table"
        :empty-text="t('mine.noCommissionRecord')"
        stripe
      >
        <el-table-column
          prop="remark"
        ...
        <el-table-column
          prop="money_display"
          :label="t('records.commissionAmount')"
          width="150"
          align="right"
        >
...
async function getFanyongRecords() {
  ...
  try {
    ...
    ElMessage.error(t('mine.getCommissionRecordFailed'))
    list.value = []
    total.value = 0
  } finally {
    loading.value = false
